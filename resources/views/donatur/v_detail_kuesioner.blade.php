        ...
        <div class="col-xl-12 col-lg-12" data-aos="fade-up">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold">{{ $sub_title }} Tanggal
                        {{ date('d-m-Y H:i:s', strtotime($data->tanggal_donor)) }}</h6>
                </div>
                @if (session('berhasil'))
                                ...
                                <div class="col-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control " name="hb" id="hb"
                                            placeholder="Masukan Hemoglobin" value="{{ $data->hb }}" readonly>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control " name="tekanan_darah"
                                            ...
                                            value="{{ $data->tekanan_darah }}" readonly>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control " name="berat_badan" id="berat_badan"
                                            placeholder="Masukan Berat Badan" value="{{ $data->berat_badan }}" readonly>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                ...
                                <div class="col-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control " name="denyut_nadi" id="denyut_nadi"
                                            placeholder="Masukan Denyut Nadi" value="{{ $data->denyut_nadi }}" readonly>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control " name="keadaan_umum"
                                            ...
                                            value="{{ $data->keadaan_umum }}" readonly>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control " name="keadaan_umum"
                                            id="keadaan_umum" value="{{ $data->catatan_pendonor }}" readonly>
                                    </div>
                                </div>
                            </div>
                        @else
                ...
                <div class="row p-3">
                    <div class="col-4">
                        <a href="/riwayat_donor" class="btn btn-danger">Kembali</a>
                    </div>
                </div>
            </div>
        </div>
