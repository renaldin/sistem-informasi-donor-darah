            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row border-bottom mb-3">
                        ...
                        @if ($data_donor->nomor_antrian != null)
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                        ...
                        @else
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                        id="nama" name="nama" placeholder="Masukan Nama"
                                        value="{{ $data_donor->nama_anggota }}" readonly>
                                    @error('nama')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('alamat') is-invalid @enderror"
                                        id="alamat" name="alamat" placeholder="Masukan Alamat"
                                        value="{{ $data_donor->alamat . ', Kec. ' . $data_donor->kecamatan . ', Kab. ' . $data_donor->kabupaten }}"
                                        readonly>
                                    @error('alamat')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                    @enderror
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('jenis_kelamin') is-invalid @enderror"
                                        id="jenis_kelamin" name="jenis_kelamin" placeholder="Masukan Jenis Kelamin"
                                        value="{{ $data_donor->jenis_kelamin }}" readonly>
                                    @error('jenis_kelamin')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" onkeydown="return hanyaAngka(event)"
                                        class="form-control @error('no_wa') is-invalid @enderror" id="no_wa"
                                        name="no_wa" placeholder="Masukan Nomor Whatsapp"
                                        value="{{ $data_donor->no_wa }}" required readonly>
                                    @error('no_wa')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control " name="tinggi_badan" id="tinggi_badan"
                                        placeholder="Masukan Tinggi Badan" value="{{ $data_donor->tinggi_badan }}"
                                        readonly>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-6">
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control " name="keadaan_umum" id="keadaan_umum"
                                        placeholder="Masukan Keadaan Umum" value="{{ $data_donor->keadaan_umum }}"
                                        readonly>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-6">
