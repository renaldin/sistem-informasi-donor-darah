...
<div class="row">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="/proses_tambah_online" method="POST">
            @csrf
            <div class="row">
                <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="input-group date">
                          ...
                          <input type="text" class="form-control @error('tanggal_kedaluwarsa') is-invalid @enderror" name="tanggal_kedaluwarsa" value="{{date('Y-m-d')}}" id="simpleDataInput">
                      </div>
