                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select
                                        class="select2-single-placeholder form-control @error('id_anggota') is-invalid @enderror"
                                        name="id_anggota" autofocus id="select2SinglePlaceholder">
                                        <option value="">Pilih</option>
                                        @foreach ($anggota as $row)
                                            @if ($row->status_anggota === 'Mandiri')
                                                <option value="{{ $row->id_anggota }}"><b>{{ $row->nama_anggota }}</b>
                                                </option>
                                            @endif
                                        @endforeach
                                    </select>
