                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control @error('id_anggota') is-invalid @enderror"
                                        name="id_anggota" id="id_anggota" value="{{ $detail->id_anggota }}"
                                        placeholder="Masukkan Nama Anggota">
                                    <input type="text" class="form-control @error('nama_anggota') is-invalid @enderror"
                                        name="nama_anggota" id="nama_anggota" value="{{ $detail->nama_anggota }}" readonly
                                        placeholder="Masukkan Nama Anggota">
                                    @error('nama_anggota')
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('jenis_kelamin') is-invalid @enderror"
                                        name="jenis_kelamin" id="jenis_kelamin" value="{{ $detail->jenis_kelamin }}"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select name="hasil_kusioner"
                                        ...
                                        id="hasil_kusioner" disabled>
                                        <option value="{{ $detail->hasil_kusioner }}">{{ $detail->hasil_kusioner }}
                                        </option>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="deskripsi_hasil_kusioner" class="form-control @error('deskripsi_hasil_kusioner') is-invalid @enderror"
                                        cols="10" rows="3" placeholder="Masukkan Deskripsi Hasil Kusioner" readonly>{{ $detail->deskripsi_hasil_kusioner }}</textarea>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('no_kantong') is-invalid @enderror"
                                        name="no_kantong" id="no_kantong" value="{{ $detail->no_kantong }}" readonly
                                        placeholder="Masukkan No. Kantong">
                                    <input type="hidden" class="form-control @error('id_darah') is-invalid @enderror"
                                        name="id_darah" id="id_darah" value="{{ $detail->id_darah }}">
                                    @error('no_kantong')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="golongan_darah"
                                        ...
                                        @if ($detail->golongan_darah)
                                            <option value="{{ $detail->golongan_darah }}">{{ $detail->golongan_darah }}
                                            </option>
                                        @else
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        name="volume_darah" id="volume_darah" value="{{ $detail->volume_darah }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="date"
                                            ...
                                            name="tanggal_kedaluwarsa" value="{{ $detail->tanggal_kedaluwarsa }}"
                                            id="simpleDataInput">
                                    </div>
