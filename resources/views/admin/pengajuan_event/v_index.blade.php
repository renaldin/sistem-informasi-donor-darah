...
@section('content')
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" data-toggle="modal"
                                                data-target="#tolak{{ $row->id_event }}"
                                                class="btn btn-danger btn-sm ">Tolak</button>
                                            <a href="/ya_pengajuan_event/{{ $row->id_event }}"
                                                class="btn btn-success btn-sm ">Terima</a>
                                            <button type="button" class="btn btn-sm btn-info" data-toggle="modal"
                                                data-target="#detail{{ $row->id_event }}">Detail</button>
                                        </td>
                                    </tr>
                                @endif
                            @endforeach
    ...
    <!-- Modal -->
    @foreach ($data_event as $row)
        <div class="modal fade" id="tolak{{ $row->id_event }}" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form action="/tidak_pengajuan_event/{{ $row->id_event }}" method="POST"
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('alasan') is-invalid @enderror"
                                            name="alasan" id="alasan" placeholder="Masukkan Alasan Menolak" required>
                                        @error('alasan')
