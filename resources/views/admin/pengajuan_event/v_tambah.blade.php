            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('kd_instansi') is-invalid @enderror" name="kd_instansi" id="kd_instansi" value="{{old('kd_instansi')}}" placeholder="Masukkan Kode Instansi">
                        @error('kd_instansi')
                            <small class="form-text text-danger">{{$message}}</small>
                        @enderror
                    </div>       
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control @error('tanggal_event') is-invalid @enderror" name="tanggal_event" value="{{date('Y-m-d')}}" min="{{date("Y-m-d")}}">
                        @error('tanggal_event')
                            <small class="form-text text-danger">{{$message}}</small>
                        @enderror
                    </div>       
