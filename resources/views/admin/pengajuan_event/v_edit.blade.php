                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        class="form-control @error('nomor_koordinator') is-invalid @enderror"
                                        name="nomor_koordinator" id="nomor_koordinator"
                                        value="{{ $detail->nomor_koordinator }}" placeholder="Masukkan Nomor Koordinator">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        name="nama_koordinator" id="nama_koordinator"
                                        value="{{ $detail->nama_koordinator }}" placeholder="Masukkan Nama Koordinator">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('tanggal_event') is-invalid @enderror"
                                        name="tanggal_event" value="{{ $detail->tanggal_event }}"
                                        min="{{ date('Y-m-d') }}">
                                    @error('tanggal_event')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                    @enderror
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="file"
                                        ...
                                        name="upload_surat" id="customFile">
                                    @error('upload_surat')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
