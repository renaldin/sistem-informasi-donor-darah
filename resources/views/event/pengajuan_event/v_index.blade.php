    ...
    <div class="col-lg-12">
        <div class="card mb-4">
            ...
            <div class="card-header flex flex-row">
                <a href="/tambah_pengajuan_event" class="btn btn-primary">Tambah Pengajuan</a>
            </div>
                    ...
                    <tbody>
                        ...
                        @foreach ($data_event as $row)
                            <tr>
                                ...
                                <td>
                                    @if ($row->status_pengajuan === 'Belum Dikirim')
                                        <button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#kirim{{$row->id_event}}">Kirim</button>
                                        <a href="/edit_pengajuan_event/{{$row->id_event}}" class="btn btn-sm btn-success">Edit</a>
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-footer">
      ...
      <a href="/hapus_pengajuan_event/{{$row->id_event}}" class="btn btn-danger">Hapus</a>
    </div>
  </div>
</div>
</div>
...
@foreach ($data_event as $row)
<div class="modal fade" id="kirim{{$row->id_event}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
<div class="modal-dialog" role="document">
  <div class="modal-content">
    <div class="modal-header">
    ...
    <div class="modal-body">
      <p>Apakah Anda yakin akan kirim pengajuan event ini?</p>
    </div>
    <div class="modal-footer">
      <button type="button" class="btn btn-outline-danger" data-dismiss="modal">Batal</button>
      <a href="/kirim_pengajuan_event/{{$row->id_event}}" class="btn btn-danger">Kirim</a>
    </div>
  </div>
</div>
</div>
