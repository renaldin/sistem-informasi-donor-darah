                ...
                <div class="col-xl-6 col-lg-12 col-md-9">
                    <div class="card shadow-sm" style="margin-top: 120px">
                        <div class="card-body p-0">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="d-flex align-items-center justify-content-center bg-danger py-1">
                                        <img src="{{ asset('foto_biodata/logo-pmi.png') }}" width="90">
                                        <div class="h4 sidebar-brand-text my-0 text-white">
                                            <b>{{ $data_web->nama_website }}</b>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="login-form">
                                        ...
                                        <hr>
                                        <div class="text-center">
                                            <a class="font-weight-bold small text-gray-900" href="/register">Belum punya
                                                akun? Register!</a>
                                        </div>
                                        <div class="text-center">
                                        </div>
