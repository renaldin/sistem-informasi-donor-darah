            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-12 col-md-9">
                    <div class="card shadow-sm"
                        style="@if ($register === 'Pilihan') margin-top: 170px @elseif($register === 'Donatur') margin-top: 7px @else margin-top: 90px @endif">
                              ...
                              @enderror
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <small class="text-danger">* required</small>
                                                            <select name="kartu"
                                                                class="form-control @error('kartu') is-invalid @enderror"
                                                                onchange="handleChange(event)" id="kartu" required>
                              ...
                              @enderror
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="tanggal_lahir"
                                                                max="{{ kurangiTahun(date('Y-m-d'), 17) }}"
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <small class="form-text text-danger">Password minimal 6
                                                                karakter</small>
                                                            @error('password')
                                                                <small
                                                                    class="form-text text-danger">{{ $message }}</small>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <button type="submit"
                                                            class="btn btn-danger btn-block">Register</button>
                                                    </div>
                                                </div>
                            ...
                            <div class="form-group">
                              ...
                              @enderror
                                            ...
                                            @else
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        <a href="/register_donatur"
                                                            class="btn btn-danger btn-block">Donatur</a>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <a href="/register_event"
                                                            class="btn btn-danger btn-block">Event</a>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <a href="/register_rumah_sakit"
                                                            class="btn btn-danger btn-block">Rumah Sakit</a>
                                                    </div>
                                                </div>
                                            @endif
                                        </form>
                                        ...
                                        <hr>
                                        <div class="text-center">
                                            <a class="font-weight-bold small text-gray-900" href="/login">Sudah punya
                                                akun? Login!</a>
                                        </div>
                                    </div>
                                </div>
